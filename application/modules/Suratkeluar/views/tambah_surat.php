<div class="row">
  <div class="col-md-12">
    <div class="card shadow-sm">
      ...
      <form class="form-horizontal" action="<?php echo site_url('Suratkeluar/tambah');?>" method="post" enctype="multipart/form-data">
        <div class="card-body">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="form-group">
                <label class="title">Nomor Surat <small class="text-danger">*</small></label>
                <input type="text" class="form-control" name="NOMOR" placeholder="Keluarkan nomor surat" required>
              </div>
              <div class="form-group">
        ...
        <div class="card-footer text-right">
          <a href="<?php echo site_url('Surat-Keluar');?>" class="btn btn-sm btn-light">Batal</a>
