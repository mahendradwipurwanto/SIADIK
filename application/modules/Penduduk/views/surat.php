                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if (end($file) == "doc" || end($file) == "docx") { ?>
                        <a href="https://docs.google.com/viewer?url=<?php echo base_url();?>berkas/suratmasuk/<?=$key->TANGGAL;?>/<?=$key->FILE;?>&embedded=true" target="_blank" class="btn btn-datatable btn-icon btn-transparent-dark" ><i class="text-warning" data-feather="eye"></i></a>
                      <?php }else { ?>
                        <a href="<?php echo base_url();?>berkas/suratmasuk/<?=$key->TANGGAL;?>/<?=$key->FILE;?>" target="_blank" class="btn btn-datatable btn-icon btn-transparent-dark" ><i class="text-warning" data-feather="eye"></i></a>
                      <?php }?>
