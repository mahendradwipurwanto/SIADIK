...
//Application Title
define('APP_TITLE', 'SIADIK - File Browser');
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/berkas';
...
$allowed_upload_extensions = 'gif,png,jpg,pdf,doc,docx';

// Favicon path. This can be either a full url to an .PNG image, or a path based on the document root.
// full path, e.g http://example.com/favicon.png
// local path, e.g images/icons/favicon.png
$favicon_path = 'assets/backend/img/logo.png';
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> TehcnoFest File Manager <?php echo VERSION; ?></a></h3></p>
...
if (isset($_GET['view'])) {
    ...
    $file_url = FM_ROOT_URL . fm_convert_win((FM_PATH != '' ? '/berkas/karya/' . FM_PATH : '') . '/' . $file);
    $file_path = $path . '/' . $file;
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a href='?p=' style='margin-left:5px;'><i class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
            ...
            $techno = "<a href='Dashboard' style='margin-right:5px;'><i class='fa fa-desktop' aria-hidden='true' title='Back to dashboard'></i></a>";
            echo '<div class="col-xs-6 col-sm-5">'. $techno.' | '. $root_url . '</div>';
            ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'SIADIK File Manager';      $tr['en']['AppTitle']           = 'SIADIK File Manager';
